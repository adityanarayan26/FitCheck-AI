  ...
  return (
    <div className="h-fit w-[350px] flex flex-col items-center justify-center glass shadow-premium p-8 rounded-3xl text-black animate-in fade-in zoom-in-95 duration-500">
      <div className="w-full text-center mb-8">
        <h1 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">Welcome Back</h1>
        <p className="text-sm text-gray-500 mt-2 font-medium">Sign in to continue to your dashboard.</p>
      </div>

      <form onSubmit={handleEmailLogin} className="flex flex-col gap-y-5 w-full">
        ...
        <Button className="w-full btn-gradient text-white font-bold py-6 rounded-xl shadow-lg shadow-purple-500/20" type='submit'>
          Sign In
        </Button>
      </form>
      ...
      <div className="w-full">
        <Button onClick={handleGoogleLogin} variant="outline" className="w-full bg-white hover:bg-gray-50 border-gray-200 text-gray-700 font-semibold py-6 rounded-xl transition-all duration-200 hover:shadow-md">
      ...
      <p className="text-xs text-center text-gray-500 mt-8 font-medium">
        ...
        <Link href="/sign-up" className="text-purple-600 hover:text-purple-700 font-bold hover:underline transition-all">
          Sign up
        </Link>
      </p>
    </div>
