  ...
  return (
    <div className="w-full bg-white border border-zinc-200 shadow-sm p-8 rounded-2xl">
      <div className="w-full text-center mb-8">
        ...
        <p className="text-sm text-zinc-500 mt-2">Sign in to continue to FitCheck AI</p>
      </div>
      ...
      <form onSubmit={handleEmailLogin} className="flex flex-col gap-y-4 w-full">
        ...
        <Button
          className="w-full bg-brand-lime text-black hover:bg-brand-lime/90 font-semibold py-5 rounded-lg transition-all"
          type='submit'
        >
          Sign In
        </Button>
      ...
      <div className="w-full space-y-4">
        <Button onClick={handleGoogleLogin} variant="outline" className="w-full bg-white hover:bg-zinc-50 border-zinc-200 text-zinc-700 py-5 rounded-lg transition-all">
      ...
      <p className="text-sm text-center text-zinc-500 mt-8">
        ...
        <Link href="/sign-up" className="text-zinc-900 hover:text-black font-semibold hover:underline transition-all">
          Sign up
        </Link>
      </p>
    </div>
